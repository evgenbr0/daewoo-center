...
(function () {
  ...
  /* ---------- Прайс-аккордеон — открыт только один ---------- */
  var priceGroups = Array.prototype.slice.call(document.querySelectorAll(".price__group"));
  priceGroups.forEach(function (item) {
    item.addEventListener("toggle", function () {
      if (item.open) priceGroups.forEach(function (o) { if (o !== item) o.open = false; });
    });
  });
